...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 77.0, 422.0, 354.0, 163.0 ],
					"varname" : "vz.playr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 834.0, 611.0, 214.0, 20.0 ],
					"text" : "régler le seuil de détection"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 751.5, 611.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 712.5, 724.0, 243.0, 20.0 ],
					"text" : "0 si pas de mouvement / 1 si mouvement"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 679.5, 722.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 795.0, 376.5, 214.0, 20.0 ],
					"text" : "régler la zone de sélection"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 712.5, 405.0, 125.0, 20.0 ],
					"text" : "y coin inf droit"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1074.0, 405.0, 105.0, 20.0 ],
					"text" : "y coin sup gauche"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1074.0, 427.0, 170.0, 21.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 712.5, 427.0, 170.0, 21.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 532.5, 405.0, 125.0, 20.0 ],
					"text" : "x coin inf droit"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 894.0, 405.0, 121.0, 20.0 ],
					"text" : " x coin sup gauche"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 721.5, 457.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1094.0, 457.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 903.0, 459.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 894.0, 427.0, 170.0, 21.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 547.5, 457.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 532.5, 428.0, 170.0, 21.0 ],
					"size" : 256.0
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 309.5, 765.0, 199.0, 131.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Scratch4MAX - Vidéo - détection Mouvement Zone"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 309.5, 670.0, 351.0, 22.0 ],
					"text" : "s4M.video.gl.detectionMouvementZone 360 288 83 249 32 80 0.",
					"varname" : "s4M.video.gl.detectionMouvementZone"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 300.0, 657.25, 378.0, 46.5 ],
					"proportion" : 0.39
				}
...
,
		"dependency_cache" : [ 			{
				"name" : "s4M.video.gl.detectionMouvementZone.maxpat",
