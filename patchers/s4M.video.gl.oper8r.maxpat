...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 721.5, 239.0, 87.0, 23.0 ],
					"restore" : [ 0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 576.5, 208.0, 111.0, 127.0 ],
					"text" : "bidouille pour recharger\nl'opérateur lorsque loadmess quand vidéo opengl car sinon l'opérateur est bloqué par le gate de map-operator"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 525.0, 273.4305419921875, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 535.5, 184.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 540.25, 313.0, 29.5, 22.0 ],
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 535.5, 230.0, 39.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 712.5, 384.0, 73.0, 22.0 ],
					"text" : "vzgl-routegl"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 258.0, 486.0, 83.0, 22.0 ],
					"text" : "vzgl-routemat"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 2.474807977676392, 16.0, 62.0, 21.0 ],
					"text" : "OPER8R",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 236.0, 575.5, 20.0, 22.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 258.0, 575.5, 20.0, 22.0 ],
					"text" : "t l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 352.5, 575.5, 20.0, 22.0 ],
					"text" : "t l"
				}
...
,
					"patching_rect" : [ 592.0, 422.0, 139.5, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 379.0, 61.170532000000001, 46.0, 22.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "off" ],
					"patching_rect" : [ 379.0, 91.170531999999994, 30.0, 22.0 ],
					"text" : "t off"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "on" ],
					"patching_rect" : [ 414.0, 91.170531999999994, 31.0, 22.0 ],
					"text" : "t on"
				}
...
,
					"patching_rect" : [ 423.5, 486.0, 89.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 258.0, 184.0, 30.0, 22.0 ],
					"text" : "t l 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 341.5, 184.0, 30.0, 22.0 ],
					"text" : "t l 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 441.0, 184.0, 54.0, 22.0 ],
					"text" : "gate 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 476.0, 422.0, 32.5, 22.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 352.5, 539.0, 57.0, 22.0 ],
					"text" : "jit.gl.slab"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 476.0, 135.0, 186.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 341.5, 422.0, 30.0, 22.0 ],
					"text" : "t l l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 258.0, 135.0, 186.0, 22.0 ],
					"text" : "routepass jit_matrix jit_gl_texture"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 352.5, 486.0, 67.0, 22.0 ],
					"text" : "vzgl-object"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 331.0, 92.170531999999994, 40.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 0.474808007478714, 15.783485412597656, 120.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 454.0, 92.170531999999994, 85.0, 23.0 ],
					"text" : "video-handler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "jit_matrix", "", "off" ],
					"patching_rect" : [ 236.0, 92.170531999999994, 85.0, 23.0 ],
					"text" : "video-handler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 766.5, 135.0, 92.0, 23.0 ],
					"text" : "scale 0. 1. 0 32"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 766.5, 107.0, 88.0, 23.0 ],
					"text" : "data-handler"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "jit_gl_texture" ],
					"patching_rect" : [ 454.0, 47.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 767.5, 41.0, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 753.0, 346.0694580078125, 72.0, 22.0 ],
					"text" : "prepend op"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 258.0, 539.0, 56.0, 23.0 ],
					"text" : "jit.op"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 891.0, 102.1705322265625, 15.0, 15.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 721.5, 313.0, 100.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 23.217376708984375, 69.792236328125, 62.0, 20.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 23.217376708984375, 49.792236328125, 62.0, 21.0 ],
					"text" : "operation",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 506.5, 177.928955078125, 186.0, 168.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 776.0, 277.00000022656252, 731.0, 277.00000022656252 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 762.5, 373.280486999999994, 267.5, 373.280486999999994 ],
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-51", 0 ],
					"midpoints" : [ 845.0, 129.00000022656252, 879.0, 129.00000022656252, 879.0, 90.000000226562506, 900.0, 90.000000226562506 ],
					"source" : [ "obj-50", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 900.0, 126.000000226562506, 867.25, 126.000000226562506, 867.25, 96.000000226562506, 845.0, 96.000000226562506 ],
					"source" : [ "obj-51", 0 ]
				}
